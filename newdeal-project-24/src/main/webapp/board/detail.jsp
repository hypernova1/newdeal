...
<jsp:include page="/header.jsp"></jsp:include>
	...
	<form action="./update" method="post">
		<table border='1'>
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" name="writerNo" value="${board.writer.name}" readonly="readonly"></td>
			</tr>
			<tr>
				<th>수업</th>
				<td><input type="text" name="lessonNo" value="${board.lesson.title}" readonly="readonly"></td>
			</tr>
			<tr>
	      <td>
		      <button>변경</button>
