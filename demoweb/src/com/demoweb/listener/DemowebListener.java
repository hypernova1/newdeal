...
@WebListener
public class DemowebListener implements ServletContextListener, // Web Application Start, Stop Event
  ...
  public void contextDestroyed(ServletContextEvent arg0) {
    ...
    try {
      ...
      String path = arg0.getServletContext().getRealPath("counter.txt");
      BufferedWriter writer =
          new BufferedWriter(new OutputStreamWriter(new FileOutputStream(path)));
      writer.write(arg0.getServletContext().getAttribute("total") + "\r\n");
      writer.flush();
      writer.close();
    } catch (Exception ex) {
    }
