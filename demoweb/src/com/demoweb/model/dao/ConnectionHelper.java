  ...
  public static Connection getConnection(String dbname) {
    ...
    if (dbname.toLowerCase().equals("oracle")) {
      try {
        ...
        /*
         * Context context = (Context)initContext.lookup("java:/comp/env"); DataSource source =
      ...
      try {
        ...
        Connection conn =
            DriverManager.getConnection("jdbc:mysql://localhost:3306/demoweb", "devadmin", "mysql");

        // 2.
        /*
         * Context initContext = new InitialContext(); Context context =
         * (Context)initContext.lookup("java:/comp/env"); DataSource source =
         * (DataSource)context.lookup("mysql/demoweb"); Connection conn = source.getConnection();
         */
        return conn;
      } catch (Exception ex) {
        return null;
