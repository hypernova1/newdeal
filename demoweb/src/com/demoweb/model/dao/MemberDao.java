...
public class MemberDao {
  ...
  public void insert(Member member) {
    ...
    try {
      ...
      String sql = "INSERT INTO member (" + "memberid, passwd, email, usertype, active) "
          + "VALUES (?, ?, ?, ?, ?)";
  ...
  public ArrayList<Member> getList() {
    ...
    try {
      conn = ConnectionHelper.getConnection(dsn);
      String sql = "SELECT memberid, email, usertype, active, regdate " + "FROM member";
      pstmt = conn.prepareStatement(sql);
  ...
  public Member getMemberById(String id) {
    ...
    try {
      conn = ConnectionHelper.getConnection(dsn);
      String sql =
          "SELECT memberid, email, usertype, active, regdate " + "FROM member WHERE memberid = ?";
      pstmt = conn.prepareStatement(sql);
