				...
				<div id="inputmain">
					...
					<form action="sendmail.jsp" method="post">
						<table>
							<tr>
								<th>받는이</th>
								<td><input type="text" name="to" style="width: 550px" /></td>
							</tr>
							<tr>
								<th>보내는이</th>
								<td><%=((Member) session.getAttribute("loginuser")).getEmail()%>
								</td>
							</tr>
							<tr>
								<th>제목</th>
								<td><input type="text" name="subject" style="width: 550px" />
								</td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea name="content" rows="20" cols="95"></textarea>
								</td>
							</tr>
						</table>
						<div class="buttons">
