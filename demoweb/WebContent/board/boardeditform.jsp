			...
			<div id="inputcontent">
				<div id="inputmain">
						...
						<table>
							<tr>
								...
								<td><input type="hidden" name="pageNo" value="<%=pageNo%>" />
									...
									value="<%=board.getBoardNo()%>" /> <input type="text"
									name="title" style="width: 550px" value="<%=board.getTitle()%>" /></td>
							</tr>
							<tr>
								<th>작성자</th>
							...
							<tr>
								<th>내용</th>
								<td>
									<textarea name="content" style="width: 580px" rows="15">
										<%=board.getContent()%>
									</textarea>
								</td>
							</tr>
					...
					<div class="buttons">
						...
						<a href="javascript:document.forms[0].submit();">수정</a> &nbsp; <a
