...
<%!//선언문 : 메서드나 변수를 선언하는 스크립트 영역
  String getTitleString(Board board, int pageNo) {
    ...
    if (!board.isDeleted()) {//
      title.append("<a href='boardview.jsp").append("?boardno=").append(board.getBoardNo())
          .append("&pageno=").append(pageNo).append("'>").append(t.replaceAll(" ", "&nbsp;"))
          .append("</a>");
    } else {
      title.append("<span style='color:gray' ").append("onclick='alert(\"삭제된 글입니다.\");'>")
          .append(t.replaceAll(" ", "&nbsp;")).append("&nbsp;[삭제된 글]").append("</span>");
    }
...
<body>
	...
	<div id="pageContainer">
		...
		<div style="padding-top: 25px; text-align: center">
			...
			<input type="button" value="글쓰기" style="width: 300px; height: 25px"
				onclick="javascript:location.href='boardwriteform.jsp';" /> <br />
			<br />
			...
			<table border="1" align="center">
				...
				<tr style="height: 25px">
					...
					<td style="text-align: left; padding: 5px"><%=getTitleString(board, currentPage)%>
					</td>
