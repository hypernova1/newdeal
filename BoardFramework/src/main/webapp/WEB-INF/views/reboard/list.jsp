...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr valign="bottom">
		...
		<td width="100%" style="padding-left: 6px" valign="bottom">새글 
		  <b>
...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	<tr>
		<td class="bg_board_title_02" height="1" colspan="11" style="overflow: hidden; padding: 0px"></td>
	</tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr valign="top">
		<td nowrap>
      <img src="${root}/img/board/btn_write_01.gif" class="writeBtn" width="64" height="22" border="0" align="absmiddle" alt="글쓰기"></td>
