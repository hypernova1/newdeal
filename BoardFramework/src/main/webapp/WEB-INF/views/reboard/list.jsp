...
<section>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr valign="bottom">
			...
			</b> / 전체 <font class="text_acc_02">${navigator.totalArticleCount}</font>
			</td>
			<td width="300" nowrap>
				<div align="right"></div>
			</td>
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td width="50%"></td>
			<td nowrap><select id="skey" name="key" class="inp">
					<option value="subject">글제목
					<option value="name">글쓴이
					<option value="seq">글번호
			</select> <span> <input type="text" id="sword" name="word" size="22"
