...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td valign="bottom" nowrap>
		  <img src="${root}/img/board/btn_write_01.gif" class="writeBtn" width="64" height="22" border="0" align="absmiddle" alt="글쓰기">
			<img src="${root}/img/board/btn_reply.gif" width="40" height="22" border="0" align="absmiddle" alt="답글">
		</td>
		<td valign="bottom" width="100%" style="padding-left: 4px"></td>
		<td align="right" nowrap valign="bottom">
		  <label class="newPage">최신목록</label><font color="#c5c5c5">|</font>
		  <label class="movePage">목록</label><font color="#c5c5c5">|</font>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr height="26">
		...
		<td style="padding-right: 14px" nowrap class="stext">
		    조회 :<font class="text_commentnum">${article.hit}</font> &nbsp;
		   스크랩 : <font class="text_commentnum">0</font> &nbsp;
            날짜 : <font class="text_commentnum">${article.logtime}</font>
    </td>
	</tr>
	<tr>
		<td class="bg_board_title_02" colspan="2" height="1" style="overflow: hidden; padding: 0px">
		</td>
	</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <img src="${root}/img/board/icon_up.gif" border="0" align="absmiddle"
			hspace="3">윗글<font color="#c5c5c5">|</font> <a
			href="javascript:goBbsRead();">아랫글<img
			src="${root}/img/board/icon_down.gif" border="0" align="absmiddle"
			hspace="3"></a></td>
	</tr>
